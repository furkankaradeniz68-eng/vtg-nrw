...
export default async function KontoauszuegePage({
  ...
  const downloads = verfahren ? await getDownloadsForVerfahren(verfahren.nr, "kontoauszuege") : [];

  return (
    <>
      <PageHero title="Kontoauszüge" />
          ...
          <>
            ...
            {downloads.length > 0 ? (
              ...
              <p className="text-base leading-relaxed text-neutral-700">
                Für dieses Verfahren wurden noch keine Kontoauszüge hinterlegt.
              </p>
            )}
          </>
        ) : id && !zugriffErlaubt ? (
